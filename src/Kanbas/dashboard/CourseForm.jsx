    ...
    <>
      <form className='add-course-form'>
        <div class="form-row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="validationDefault01" 
              placeholder="First name" value={course.name} required
...

        {
          formType === "EDIT" 
          ?
          <button class="btn btn-primary" type="submit" onClick={editCourse}>Edit Course</button>
          :
          <button class="btn btn-primary" type="submit" onClick={addCourse}>Add Course</button>
        }
        
        <button class="btn btn-danger ms-3" type="submit" onClick={() => setHiddenForm(!hiddenForm)}>Cancel</button>
      </form>
    </>
  )
}
