    ...
    <>
      ...
      <div class="col extra">
        ...
        <ul>
          ...
          <li>
            <a href=".">
              <button class="btn kanbas-btn-gray ">Import From Commons</button>
            </a>
          </li>
          <li>
            <a href=".">
              <button class="btn kanbas-btn-gray ">Choose Homepage</button>
            </a>
          </li>
          <li>
            <a href=".">
              <button class="btn kanbas-btn-gray ">View Course Stream</button>
            </a>
          </li>
          <li>
            <a href=".">
              <button class="btn kanbas-btn-gray ">New Announcements</button>
            </a>
          </li>
          <li>
            <a href=".">
              <button class="btn kanbas-btn-gray ">New Analytics</button>
            </a>
          </li>
          <li>
            <a href=".">
